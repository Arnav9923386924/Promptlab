...
from promptlab.testgen.doc_corpus import is_blocked_domain
from promptlab.testgen.doc_index import Chunk, DocumentIndex, RetrievalResult
...
class DocGroundedGenerator:
    ...
    def _map_chunks_to_intents(
        ...
        from promptlab.testgen.doc_index import _tokenize
